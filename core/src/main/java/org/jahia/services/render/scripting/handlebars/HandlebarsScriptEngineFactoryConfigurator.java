 ...
 */
public class HandlebarsScriptEngineFactoryConfigurator implements BundleScriptEngineFactoryConfigurator<HandlebarsScriptEngineFactory> {
    private ServiceTracker<Helper, Helper> helperServiceTracker;

    @Override
    public void configure(final HandlebarsScriptEngineFactory scriptEngineFactory, final Bundle bundle, ClassLoader classLoader) {
        ...
        ServiceTrackerCustomizer<Helper, Helper> serviceTrackerCustomizer = new ServiceTrackerCustomizer<Helper, Helper>() {
            ...
            public Helper addingService(ServiceReference reference) {
                ...
                scriptEngineFactory.getHelpers().put(getHelperName(reference, addedHelper), addedHelper);
